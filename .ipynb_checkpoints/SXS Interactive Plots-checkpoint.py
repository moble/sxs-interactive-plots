...
def _():
    ...
    import sxs_iplots_marimo as isxs
    return bilby, isxs, plt, re, sxs
...
@app.cell
def _(mo):
    Distance = mo.ui.slider(100.0,10000.0,10.0)
    Distance
    return (Distance,)
...
@app.cell
def _(mo):
    Mass = mo.ui.slider(33.0,10000.0,10.0)
    Mass
    return (Mass,)
...
def _(
    ...
    isxs.iplt_lm(h=h2139_1, t=t2139, metadata=metadata2139, Mass=Mass.value, Distance=Distance.value, cut=False)
